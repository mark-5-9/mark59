...
public class SimpleAES {
	...
	public static String decrypt(String strToDecrypt) {
		return decrypt(strToDecrypt, AppConstants.REFERENCE);
	}
	...
	public static void main(String[] args) {
		...
		String encryptedString = SimpleAES.encrypt(originalString, AppConstants.REFERENCE );
		String decryptedString = SimpleAES.decrypt(encryptedString, AppConstants.REFERENCE);
