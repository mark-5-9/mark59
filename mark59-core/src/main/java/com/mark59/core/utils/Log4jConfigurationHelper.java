...
/**
 * This class is designed to allow log4j messages to be displayed at the requested level when testing a script (in an IDE for example), 
 * without the need for any other log4j configuration.<p>
