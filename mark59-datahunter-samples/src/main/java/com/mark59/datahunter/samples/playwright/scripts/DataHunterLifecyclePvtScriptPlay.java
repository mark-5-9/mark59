...
public class DataHunterLifecyclePvtScriptPlay  extends PlaywrightAbstractJavaSamplerClient {
	...
	protected Map<String, String> additionalTestParameters() {
		...
		jmeterAdditionalParameters.put("START_NETWORK_LISTENERS", String.valueOf(true));
		...
		jmeterAdditionalParameters.put(ScriptingConstants.BROWSER_EXECUTABLE, "C:\\Jmeter\\_config\\chromium_ungoogled\\chrome.exe");
...
//		System.out.println("Thread " + lifecycle + " is running with LOG level " + LOG.getLevel());
		...
		boolean startNetListeners = Boolean.parseBoolean(context.getParameter("START_NETWORK_LISTENERS"));
