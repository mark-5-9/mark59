 ...
 * in the mark59-metrics application. Credentials on the auth header will need to match the values of properties
...
public class ServerMetricsCaptureViaWeb extends AbstractJavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			...
			LOG.debug("        last response code from mark59-metrics was  \n" + repsonseCode);
