...
#   |  -  to execute the DataHunter (Selenium) JMeter test, type : ./DataHunterExecuteJmeterSeleniumTest.sh 
#   |  
...
{   # try  
    ...
    gnome-terminal -- sh -c "~/apache-jmeter/bin/jmeter -n -X -f  -t ./test-plans/DataHunterSeleniumTestPlan.jmx -l ~/Mark59_Runs/Jmeter_Results/DataHunter/DataHunterTestResults.csv -JDataHunterUrl=http://localhost:8081/mark59-datahunter -JForceTxnFailPercent=0 -JStartCdpListeners=false; exec bash"
