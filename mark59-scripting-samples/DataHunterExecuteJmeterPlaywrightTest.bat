REM   -------------------------------------------------------------------------------------------------------------------------------------------------
REM   |  Execute DataHunterPlaywrightTestPlan in non-gui mode 
REM   | 
REM   |  Sample Usage.
REM   |  ------------
...
REM   |  -  to execute the DataHunter Playwright JMeter test, type : DataHunterExecuteJmeterPlaywrightTest.bat   ( or just double-click on this file )   
REM   -------------------------------------------------------------------------------------------------------------------------------------------------
@echo off
MODE con:cols=180 lines=500

ECHO Starting Execution of DataHunterPlaywrightTestPlan 
...
C:\apache-jmeter\bin\jmeter -n -X -f -t ./test-plans/DataHunterPlaywrightTestPlan.jmx -l C:\Mark59_Runs\Jmeter_Results\DataHunter\DataHunterTestResults.csv -j C:\apache-jmeter\bin\jmeter.log -JDataHunterUrl=http://localhost:8081/mark59-datahunter -JForceTxnFailPercent=0 -JStartCdpListeners=%StartCdpListeners%
PAUSE