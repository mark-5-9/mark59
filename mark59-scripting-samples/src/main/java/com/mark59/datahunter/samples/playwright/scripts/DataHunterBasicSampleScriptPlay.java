 ...
 *   
 * <p>This type of scripting would be appropriate when our are knocking out a 'quick and dirty' script for a simple application. It will 
 *  quickly become too limited, cumbersome and difficult to maintain for more complex application tests, where DSL style scripts could be
 *  used (even if its just a repository of all well-named locators for the all target html elements).   
 * 
