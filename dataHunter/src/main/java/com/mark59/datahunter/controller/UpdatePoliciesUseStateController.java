...
//		System.out.println("/update_policies_use_state");
		List<String> usabilityListFrom = new ArrayList<String>(AppConstants.USEABILITY_LIST);
		usabilityListFrom.add(0,"");
		model.addAttribute("usabilityListFrom",usabilityListFrom);
		List<String> usabilityListTo = new ArrayList<String>(AppConstants.USEABILITY_LIST);
