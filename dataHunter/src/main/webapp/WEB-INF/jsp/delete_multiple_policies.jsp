...
<body>
 ...
 <b>Delete Multiple Policies Matching Selection Criteria</b> 
  ...
  <div>
   ...
   <form:form method="post" action="delete_multiple_policies_action" modelAttribute="policySelectionCriteria">
    <table >
     <tr>
      <td>Application :</td>
