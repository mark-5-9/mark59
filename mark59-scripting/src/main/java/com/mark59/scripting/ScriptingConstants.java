...
/**
 * Constants used for Mark59 scripting configuration and parameters.
 * This utility class defines constants for browser settings, Playwright options,
 * proxy configuration, and other scripting-related parameters.
 *
 * @author Philip Webb
