...
public class JmeterFunctionsForPlaywrightScripts extends AbstractJmeterFunctionsUiCommon {
	...
	/**
	 * Constructs a JmeterFunctionsForPlaywrightScripts instance.
	 *
	...
	/**
	 * Gets the Playwright page associated with this instance.
	 *
	...
	/**
	 * Sets the Playwright page for this instance.
	 *
