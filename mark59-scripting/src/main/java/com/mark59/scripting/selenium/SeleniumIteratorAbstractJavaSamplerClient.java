...
public abstract class SeleniumIteratorAbstractJavaSamplerClient extends SeleniumAbstractJavaSamplerClient implements UIiterator {
	...
	/**
	 * Constructor for SeleniumIteratorAbstractJavaSamplerClient.
	 */
	public SeleniumIteratorAbstractJavaSamplerClient() {
		super();
	}
	...
	/**
	 * abstract definition initiateSeleniumTest
	...
	/**
	 * abstract definition iterateSeleniumTest
	 * @param context JavaSamplerContext
	 * @param jm JmeterFunctionsForSeleniumScripts
	 * @param driver WebDriver
	 */
	...
	/**
	 * abstract definition finalizeSeleniumTest
	 * @param context JavaSamplerContext
	 * @param jm JmeterFunctionsForSeleniumScripts
	 * @param driver WebDriver
	 */
