...
public abstract class SeleniumAbstractJavaSamplerClient extends UiAbstractJavaSamplerClient {
	...
	/**
	 * Constructor for SeleniumAbstractJavaSamplerClient.
	 */
	public SeleniumAbstractJavaSamplerClient() {
		super();
	}

	/**
	 * Builds the base map of static arguments for Selenium implementations.
	 *
	 ...
	 * <li>{@link UiAbstractJavaSamplerClient#ON_EXCEPTION_WRITE_PERF_LOG} - Chromium Performance Log, unwritten or unbuffered records
	 * when exception occurred</li>
