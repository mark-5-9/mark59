...
public class SeleniumDriverFactory {
	...
	/**
	 * "BROWSER_LAUNCH_ARGS" - a comma delimited list of browser launch arguments (primarily Chromium command-line switches).
	 * Refer to the 'see also' below for details.
	 * @see com.mark59.scripting.selenium.interfaces.DriverFunctionsSeleniumBuilder#setBrowserLaunchArgs(java.util.List)
	 */
	public static final String BROWSER_LAUNCH_ARGS = ScriptingConstants.BROWSER_LAUNCH_ARGS;
	 ...
	 *  <br><b>SeleniumDriverFactory.BROWSER_LAUNCH_ARGS</b>&emsp;("BROWSER_LAUNCH_ARGS") - allows for browser launch arguments (primarily Chromium switches)
