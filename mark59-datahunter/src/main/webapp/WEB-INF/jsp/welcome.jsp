...
<table>
	...
	<c:if test="${currentDatabaseProfile == 'h2mem' }">
		<tr><td valign="top"><img src="icons/h2-logo.png" height="40" width="40"/></td> <td><a href="http://${urltoContext}/h2-console">H2 Database Console <br>URL: jdbc:h2:mem:huntermem</a></td></tr>
	</c:if>  	
