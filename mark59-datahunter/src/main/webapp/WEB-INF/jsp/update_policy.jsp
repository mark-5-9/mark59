...
<div class="content"> 
  ...
  <h1>Update an Item - Selection</h1>  
  
  <c:if test="${map.reqErr != ''}">
	<p style="color:red"><b>${map.reqErr}</b></p> 
  </c:if>    
  
  <form:form method="post" action="update_policy_data" modelAttribute="policySelectionCriteria">
   <table >
    <tr>
     <td class="tip" colspan=3 >You must specify the item's full key: Application, Identifier and Lifecycle 
     	(a blank value is assumed if not entered)<br></td>
    </tr>   
    <tr>
     <td width="71">Application</td>
     <td width="6">:</td>      
     <td width="301"><form:input path="application" size="64" height="20" onchange="trimkey(this)" /></td>
    </tr>
    <tr>
     <td width="71">Identifier</td>
     <td width="6">:</td>      
     <td width="301"><form:input path="identifier" size="64" height="20" onchange="trimkey(this)" /></td>
    </tr>
    <tr>
     <td width="71">Lifecycle</td>
     <td width="6">:</td>            
     <td width="301"><form:input path="lifecycle" size="64" height="20" onchange="trimkey(this)" /></td>
    </tr>
    <tr>
     <td colspan="3"><br><input type="submit" value="select" id="select" /></td>
    </tr>
   </table>
  </form:form>
