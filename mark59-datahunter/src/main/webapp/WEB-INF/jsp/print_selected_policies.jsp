...
<html>
<head>
<title>Print Selected Items</title>
...
<body>
 ...
 <b>Print Items Matching Selection Criteria</b> 
  ...
  <div>
   ...
   <form:form method="post" action="print_selected_policies_action" modelAttribute="policySelectionCriteria">
    <table >
     <tr>
      <td>Application :</td>
