...
public class Sla {
	...
	public Sla(Sla copy) {
		this.slaApplicationKey = copy.slaApplicationKey;
	...
	public String getSlaApplicationKey() {
		return slaApplicationKey;
	}

	public void setSlaApplicationKey(String slaApplicationKey) {
		this.slaApplicationKey = slaApplicationKey;
	}
