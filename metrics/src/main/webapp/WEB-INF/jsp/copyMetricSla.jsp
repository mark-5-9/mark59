...
<html>
<head>
<title>Mark - Copy Metric SLA</title>
...
<p>&nbsp;</p>
  ...
  <div>
   <form:form method="post" action="insertMetricSla?reqApp=${map.reqApp}" modelAttribute="metricSla">
    <table>
     <tr>
      <td>Metric (name):</td><td> ${map.metricSla.originalMetricName} </td>
     </tr>
     ...
     <tr>
      <td>Application:</td>
      <td><form:input path="application" value="${map.metricSla.application}" />
      </td>
     </tr>     
     <tr>
      <td>Metric Type:</td>
