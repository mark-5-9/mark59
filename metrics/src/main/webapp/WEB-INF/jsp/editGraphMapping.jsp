...
<%--       <td><form:input path="txnType" value="${map.graphMapping.txnType}" />   </td> --%>
     </tr>
     ...
     <tr>
      <td></td>
      <td><form:textarea path="valueDerivation" class="textarea"  style="width:100%;height:30px"  />   </td>
     </tr>
      
     <tr>
      <td>UOM Description :</td>
      <td><form:input path="uomDescription" value="${map.graphMapping.uomDescription}" />    </td>
     </tr> 
     ...
     <tr>
      <td>Range Bar Sql :</td>
      <td><form:textarea path="barRangeSql" class="textarea" style="width:100%;height:150px" />    </td>
     </tr> 
     ...
     <tr>
      ...
      <td><form:input path="barRangeLegend" value="${map.graphMapping.barRangeLegend}"   size="100"  />   </td>
     </tr> 
      
     <tr>
      <td>Comment :</td>
      <td><form:input path="comment" value="${map.graphMapping.comment}"  size="100"  />   </td>
     </tr>       
