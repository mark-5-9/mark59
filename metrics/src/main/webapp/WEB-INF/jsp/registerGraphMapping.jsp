   ...
   <form:form method="post" action="insertGraphMapping" modelAttribute="graphMapping">
    <table>
     <tr>
      ...
      <tr>
      <td>Graph name:</td>
      <td><form:input path="graph"/></td>
      <td></td>
     </tr>
     
     <tr>
      <td>Transaction Type: </td>
<%--       <td><form:input path="txnType" />&nbsp;&nbsp; choose: TXN,DATAPOINT,CPU_UTIL,MEMORY</td> --%>
     ...
     <tr>
      <td></td>
      <td colspan=2 ><form:textarea path="valueDerivation" style="width:100%;height:30px" /></td>
        
     </tr>
     
     <tr>
      <td>UOM Description:</td>
      <td><form:input path="uomDescription" /></td>
      <td></td>     
     </tr> 
     ...
     <tr>
      <td>Range Bar Sql :</td>
      <td><form:textarea path="barRangeSql"  style="width:100%;height:150px" value="xxxx"   />
      </td>
     </tr> 
     ...
     <tr>
      ...
      <td><form:input path="barRangeLegend" value="${map.graphMapping.barRangeLegend}"  size="100" />
      </td>
     </tr> 
