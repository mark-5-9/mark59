...
#     |
#     | NOTE - mark59serverprofiles.xlsx is not copied. Before you run the '..usingExcel' testplan, copy it manually to the JMeter bin directory
...
echo This script deploys Mark59 artefacts to apache-jmeter, then executes JMeter plan DataHunterPlaytwrightTestPlan.jmx
