...
REM   |
REM   | NOTE - you need to ensure the chromedriver.exe file at root of mark59-scripting-samples project is compatible with your Chrome version
...
REM copied from DeployDataHunterTestArtifactsToJmeter.bat in the mark59-scripting-samples project ..
...
CALL DataHunterExecuteJmeterSeleniumTest.bat
