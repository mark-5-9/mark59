...
<div class="content"> 
  ...
  <div>
   ...
   <table>
	 ...
	 <!-- For Server Profile Registration, only allow profile name entry until executor selected  -->
     <c:if test="${!commandexecutor.equals('')}">
     ...
     <c:if test="${commandexecutor.equals('GROOVY_SCRIPT')}">
	   <tr> 
   	 ...
   	 </c:if> <!-- end c:if For Server Profile Registration, only allow profile name entry until executor selected -->
