 ...
 <form method="post" action="loginAction">
		...
		<table>
			...
			<tr>
				...
				<td><input type="text" id="username" name="username" autocomplete="username" required="required" maxlength="128" /></td>
				<td></td>
			</tr>
			<tr>
				<td><label for="password">Password&nbsp;:</label></td>
				<td><input type="password" id="password" name="password" autocomplete="current-password" required="required" maxlength="128" /></td>
				<td></td>
			</tr>
