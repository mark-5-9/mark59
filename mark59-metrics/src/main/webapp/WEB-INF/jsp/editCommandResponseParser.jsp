...
<html>
<head>
<title>Server Metrics Via Web - Edit Command Response Parser</title>
...
<div class="content"> 
  ...
  <h1>Edit Command Response Parser</h1> 
  <p>&nbsp;</p> 
  
  <div>
    <form:form method="post" action="updateCommandResponseParser?reqMetricTxnType=${map.reqMetricTxnType}" modelAttribute="commandResponseParser" >
    ...
    <table >
     ...
     <tr>
      ...
      <td width="90%"><form:select path="metricTxnType"  items="${map.metricTxnTypes}" value="${map.commandResponseParser.metricTxnType}" /></td>
     </tr>
     <tr>
     ...
     <tr>
      ...
      <td width="90%"><form:textarea path="script" /></td>
     </tr>
     <tr>
     ...
     <tr>
      ...
      <td width="90%"><form:textarea path="sampleCommandResponse" maxlength="8000" /></td>
     </tr>
